...
const ManageBooking = () => {
    ...
    useEffect(() => {
        fetch("https://hidden-sea-52711.herokuapp.com/manageallorder")
            .then((res) => res.json())
    ...
    const handleDelete = (id) => {
        ...
        if (proceed) {
            fetch(
                `https://hidden-sea-52711.herokuapp.com/mybooking/${id}`,
                {
                    method: "DELETE",
                }
            )
    ...
    const handleUpdate = (id) => {
        ...
        const uri = `https://hidden-sea-52711.herokuapp.com/mybooking/${id}`;
        fetch(uri, {
            method: "PUT",
            headers: {
